...
######################################################################################################################################################################
print(Fore.WHITE + "")
print(Fore.RED + "[⌛]Updating your system.Please wait until the update finished")
print(Fore.WHITE + "")
...
print("")
try:
	ver1 = int(input(Fore.BLUE + "[Recommended]Do you want to upgrade these following packages[1(Yes)/2(No)]?=>"))
	if ver1 == 1:
		print(Fore.WHITE + "")

...
def docker():
	try:
		...
		print("")
		print(Fore.GREEN + "[✔]Docker Successfully installed.")
	except:
		print(Fore.RED + "[✘]An error occured while installing docker")
		pass
	#If you want to install docker just remove the # before docker() and make it executeable.
#docker()
print(Fore.WHITE + "")
